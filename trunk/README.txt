...
This WSDK release contains several improvements.

* SOAP 1.2 support:  WSDK 2.0 implements core functionality for web
  service clients

- SOAP12 namespace, and conventions for envelope, body, header, fault
- SOAP12 HTTP binding
- WSDL 1.1 binding extension for SOAP 1.2
- Not supported: SOAP12 encoding
- Not supported: additional message exchange patterns

* SOAP Attachments:  support for binary data encoded as multipart MIME
...
* XML Schema: support for additional advanced constructs

- choice, derivation by restriction, nested elements, union 

- eliminated use of type aliases for array and any types that can be
  expressed directly as Curl types

* XML Schema Datatypes: support for arbitrary precision numeric types
  provided by new COM.CURL.UTIL library
...
- makes available additional code generation directives
- records directives used for later reference
- now included in 'docs-install' distribution
...
WSDK 2.0 is supported for both Curl API Version 7.0 and 6.0.
